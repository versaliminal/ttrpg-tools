\documentclass[10pt,letterpaper,portrait]{mythic-witches}
%\geometry{left=1.25cm,right=1.25cm,top=1.5cm,bottom=1.5cm,columnsep=1.2cm}

\makeindex

\begin{document}
\newgeometry{left=0pt,bottom=0pt,top=0pt,left=0pt}
\includegraphics[height=10.99in]{img/title.png}\newpage
\clearpage
\restoregeometry
...
%    \draw[line width=5pt, color=VLRed]
%        ($(current page.north west) + (10pt,-10pt)$) rectangle
%        ($(current page.south east) + (-10pt,10pt)$);
%\end{tikzpicture}
